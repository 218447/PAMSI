...
public:
  ...
  virtual void dodajElemRazy ( T *elem); //dodawanie elementu, powiekszanie razy 2 w przypadku braku wolnego miejsca
...
template <class T> void Tablica<T>::dodajElemRazy ( T *elem) {
  ++zajete;
  if (zajete>wielkosc) {
